                ...
                <el-form
                    ...
                    <el-form-item label="标题字体">
                        ...
                        <el-select
                            ...
                            placeholder="选择字体">
                            <el-option
                                v-for="item in activities.fonts"
                                :key="item.dictValue"
                                :label="item.dictName"
                    ...
                    <el-form-item label="标题尺寸">
                        <el-slider
                            :min="activities.minSize"
                            :max="activities.maxSize"
                            style="width: 200px"
                        ...
                        <el-popover placement="right" trigger="click">
                            ...
                            <el-scrollbar style="height: 300px; width: 440px">
                                <ul
                                    ...
                                    <li
                                        class="el-upload-list__item is-ready ImageContainer"
                                        :key="url"
                                        v-for="url in editActivity.target
                                            .pictureUrls">
                                        <div
                                            class="ImageContainer clicker Imager">
                                            <el-icon
                                                @click="
