                ...
                <el-form v-if="editActivity.onEditInfo" label-width="120px" label-position="right"
                    ...
                    <el-form-item prop="title" label="活动标题">
                        <el-row style="width:100%">
                            ...
                            <el-col :span="5">
                                <el-color-picker v-model="editActivity.target.titleColor" :predefine="activities.colors" />
                            </el-col>
                            <el-col :span="7">
                                <el-slider :min="activities.minSize" :max="activities.maxSize"
                    ...
                    <el-form-item prop="subTitle" label="活动副标题">
                        <el-row style="width:100%">
                            ...
                            <el-col :span="5">
                                <el-color-picker v-model="editActivity.target.subTitleColor" :predefine="activities.colors" />
                            </el-col>
                            <el-col :span="7" size="small">
                                <el-slider :min="activities.minSize" :max="activities.maxSize"
                                    v-model="editActivity.target.subTitleSize" />
                            </el-col>
                        </el-row>
                    </el-form-item>
