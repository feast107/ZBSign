		...
		<div id="Foreground">
			...
			<el-container id="Container">
							...
							<el-row>
								<el-popover placement="bottom" :width="200" trigger="contextmenu">
									<div style="width: 200px">
										...
										<el-row>
											<el-slider v-model="activity.titleSize" :min="10" :max="100" />
										</el-row>
									</div>
									<template #reference>
							...
							<el-row v-if="activity.HasSubTitle">
								<el-popover placement="top" :width="200" trigger="contextmenu">
									<div style="width: 200px">
										...
										<el-row>
											<el-slider v-model="activity.subTitleSize" :min="10" :max="100" />
										</el-row>
									</div>
									<template #reference>
										<label class="title" id="SubTitle"
				...
				<el-container style="height: 75%">
						...
						<el-popover placement="top" :width="200" trigger="contextmenu">
							<div>
								<el-radio-group v-model="activity.pictureSpeed">
									<el-radio v-for="item in config.speeds" :key="item" :label="item"></el-radio>
								</el-radio-group>
							</div>
							<template #reference>
                    ...
                    height: 100%;
                  ">
									<Container :key="key" v-for="key in Object.keys(locals)" :canvas="locals[key]">
									</Container>
									<Container :key="key" v-for="key in Object.keys(remotes)" :canvas="remotes[key]">
									</Container>
								</div>
							</template>
						</el-popover>
