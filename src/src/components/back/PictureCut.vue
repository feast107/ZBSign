<template>
    <div class="cropper-content">
        <el-card
        style="position:absolute ; top:calc(50% - 225px); left:calc(50% - 400px);z-index: 999;" >
            <div class="cropper">
                <vue-cropper ref="cropper" 
                style="width:800px;height:450px"
                 :img="option.img" :outputSize="option.outputSize"
                    ...
                    :enlarge="option.enlarge" @realTime="realTime" @imgLoad="imgLoad">
                </vue-cropper>
            </div>
            <!--底部操作工具按钮-->
            <div class="footer-btn">
                ...
                <div class="upload-btn">
                    <el-button size="small" type="success" @click="uploadImg('blob')">上传封面 <i
                            class="el-icon-upload"></i></el-button>
                </div>
            </div>
        </el-card>
        <!--预览效果图-->
        <div v-if="false" class="show-preview">
