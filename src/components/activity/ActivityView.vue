<template>
    <div style="width:100%;height:100%">
        <el-empty v-if="cache.length == 0" style="height: 100%" description="暂无记录">
            <template #image>
        ...
        <el-col id="ActivityView" v-else style="height: 100%; width: 100%">
            <el-row justify="center" style="height: 50px; padding: 10px">
                <el-autocomplete id="AutoComplete"
                    style="box-shadow: var(--el-box-shadow-light); width: 80%;border-radius: 20px;" v-model="searchPattern"
                    :fetch-suggestions="getSuggests" clearable popper-class="my-autocomplete" placeholder="搜索活动"
                        ...
                        <el-table-column width="120">
                            <template #default="scope">
                                <el-tag style="user-select: none" size="small">{{
                                    `| 签名${0}p | 照片${scope.row.pictures.length
                                    }p`
                                }}</el-tag>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="" width="50">
                            <template #default="scope">
                                <el-popover style="
                                    ...
                                    <el-row>
                                        <el-button class="iconButton" plain type="danger" circle>
                                            <el-icon style="
                                                        width: 20px;
                                                        height: 20px;
                                                    ">
        ...
        <!-- 修改对话框 -->
        <el-dialog v-model="editActivity.onEdit" title="修改" align-center width="50%">
            <div>
                <el-form v-if="editActivity.onEdit" label-position="right" style="margin-right: 20px"
